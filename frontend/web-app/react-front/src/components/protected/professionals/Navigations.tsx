...
const navItems = [
  { path: "/professionals/dashboard", text: "Dashboard" },
  { path: "/professionals/patients", text: "Patients" },
  { path: "/professionals/alert", text: "Alert" },
];
    ...
    <nav className="relative flex items-center justify-between p-4 bg-transparent z-50">
      ...
      <DropdownMenu>
            ...
            <DropdownMenuContent className="text-center">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => navigate('/professionals/profile')}><UserRoundPen /> Profile</DropdownMenuItem>
